...
const getStyles = (colors) => StyleSheet.create({
  ...
  categoryRow: { backgroundColor: colors.card, flexDirection: 'row', paddingVertical: 8, paddingHorizontal: 12, gap: 8 },
  catBtn: { flex: 1, alignItems: 'center', paddingVertical: 8, borderRadius: 12, backgroundColor: colors.inputBg },
  ...
  imagePlaceholderText: { fontSize: 10, color: colors.primary, fontWeight: '600', marginTop: 2 },
